...
// Restore the original code where it was mistakenly replaced
const restoreStr = `                    </div>
                  );
                }`;

// Replace the first occurrence (which is the mistaken one)
code = code.replace(searchStr, restoreStr);
